...
int main(){
    ...
    while(ispravnaRuka){
        ...
        for(int j=0; j<=4; j++){
            if((znakKarte[j]==znakKarte[0] && brojKarte[j]==brojKarte[0]) ||
               (znakKarte[j]==znakKarte[1] && brojKarte[j]==brojKarte[1]) ||
               (znakKarte[j]==znakKarte[2] && brojKarte[j]==brojKarte[2]) ||
               (znakKarte[j]==znakKarte[3] && brojKarte[j]==brojKarte[3]) ||
               (znakKarte[j]==znakKarte[4] && brojKarte[j]==brojKarte[4]) ){
